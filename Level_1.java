...
public class Level_1 implements Screen {
    ...
    private World world;
    private Body[] birdBodies;  // Reduced the number of birds
    ...
    public Level_1(Game game) {  // Changed Level_2 to Level_1
        this.game = game;
    }
    ...
    public void show() {
        ...
        this.createBirdBodies();  // Reduced the number of birds
        ...
        Gdx.input.setInputProcessor(new InputAdapter() {
            public boolean touchDown(int screenX, int screenY, int pointer, int button) {
                screenY = Gdx.graphics.getHeight() - screenY;
                 if (!Level_1.this.isBirdLaunched && Level_1.this.currentBirdIndex < Level_1.this.birdBodies.length) {  // Changed Level_2 to Level_1
                    Level_1.this.launchBird((float) screenX / 100.0F, (float) screenY / 100.0F);  // Changed Level_2 to Level_1
                    return true;
                } else {
                    return false;
                }
            ...
            public boolean keyDown(int keycode) {
                if (keycode == Input.Keys.ESCAPE) {
                    ...
                    Level_1.this.restartLevel();
                    return true;
                } else if (keycode == Input.Keys.ENTER) {
                    // Go to Level 2 when the Enter key is pressed
                    Level_1.this.goToLevel2();
                    return true;
                }
    ...
    private void goToLevel2() {
        // Assuming Level_2 is another class that implements Screen
        this.game.setScreen(new Level_2(this.game));  // Transition to Level 2
    }
    ...
    private void createBirdBodies() {
        this.birdBodies = new Body[1];  // Changed from 3 birds to 1 bird
    ...
    private void drawBirds() {
        this.shapeRenderer.setColor(1.0F, 0.0F, 0.0F, 1.0F);  // Red color for the bird
    ...
    private void drawWoodBlocks() {
        this.shapeRenderer.setColor(0.5F, 0.25F, 0.0F, 1.0F);  // Brown color for the wood
    ...
    private void drawPig() {
        this.shapeRenderer.setColor(0.0F, 1.0F, 0.0F, 1.0F);  // Green color for the pig
